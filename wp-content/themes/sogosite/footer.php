			...
			<div class="col-md-12">
				<h2 class="green-txt">職種から探す</h2>
					...
					<ul class="search-job-list">
						...
						<li><a href="#">PM/PL</a></li>
						<li><a href="#">ブリッジSE（BSE）</a></li>
						<li><a href="#">システム開発エンジニア
<br>(SE/WEB/モバイル系)</a></li>
						<li><a href="#">Web・モバイルサイト
<br>（フロントエンジニア）</a></li>
						<li><a href="#">フロントエンドエンジニア</a></li>
						<li><a href="#">バックエンドエンジニア</a></li>
						<li><a href="#">サーバーエンジニア</a></li>
						<li><a href="#">モバイルエンジニア</a></li>
						<li><a href="#">サーバーエンジニア</a></li>
						<li><a href="#">ネットワーク
<br>インフラエンジニア</a></li>
						<li><a href="#">IoTシステム</a></li>
						<li><a href="#">QA・テストエンジニア</a></li>
						<li><a href="#">ゲーム</a></li>
						<li><a href="#">AI・音声・画像認識</a></li>
						<li><a href="#">営業</a></li>
						<li><a href="#">海外ポジション</a></li>
						<li><a href="#">ビックデータ</a></li>
						<li><a href="#">マーケティング</a></li>
						<li><a href="#">通訳翻訳</a></li>
						<li><a href="#">研修生サポート</a></li>
						<li><a href="#">カスタマーサポート</a></li>
						<li><a href="#">秘書</a></li>
						<li><a href="#">人事</a></li>
						<li><a href="#">総務</a></li>
						<li><a href="#">品質管理（製造業）</a></li>
						<li><a href="#">貿易</a></li>
						<li><a href="#">電気・電子</a></li>
						<li><a href="#">機械</a></li>
						<li><a href="#">看護師</a></li>
						<li><a href="#">ツアーガイド</a></li>
