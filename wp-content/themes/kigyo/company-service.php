...
<div class="right-content">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="f-blk">
                    ...
                    ?>
                <img src="<?php echo $imageThumbURL;?>">
                    <h3><?php echo get_field('title_point1'); ?></h3>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="f-blk">
                    ...
                    ?>
                <img src="<?php echo $imageThumbURL;?>">
                    <h3><?php echo get_field('title_point2'); ?></h3>
    ...
    <div class="step-section ">
        <div class="row">
            <div class="col-md-12">
                <?php if (qtrans_getLanguage()=='ja'){ ?>
                    <div class="head-bg">【ご相談・ご面談・候補者ご紹介など、<br>ご入社が確定するまで無料で対応させて頂きます。】</div>
                ...
                <div class="sub-desc">
                    急募求人から通期採用の求人、「良い人がいれば採用したい」という求<br>
                    あらゆる採用ニーズに対応いたします。<br>
